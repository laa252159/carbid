...
public class TokenEncryptorDescriptor {
    ...
    public TokenEncryptorDescriptor() {
    ...
    public static String encrypt(String plainText) throws NoSuchPaddingException, BadPaddingException,
    ...
    public static String decrypt(String encryptedText) throws NoSuchPaddingException, InvalidAlgorithmParameterException,
            NoSuchAlgorithmException, IllegalBlockSizeException, IOException, BadPaddingException,
