...
информации на сайте </span><span lang=EN-US style='text-align: left;font-size:10.0pt;font-family:
...
настоящее Соглашение. Регистрация считается завершенной, когда Пользователь
принял все пункты настоящего Соглашения.<br>
Сервис </span><span lang=EN-US style='text-align: left;font-size:10.0pt;font-family:"Cambria",serif;
...
"Cambria",serif;color:#333333'>.</span><span lang=EN-US style='text-align: left;font-size:10.0pt;
font-family:"Cambria",serif;color:#333333'>perekup</span><span lang=RU
                                                               style='text-align: left;font-size:10.0pt;font-family:"Cambria",serif;color:#333333'>64.ru
предоставляет только информационные услуги и не является участником сделок.
Сайт предоставляет возможность продавцам реализовать автомобиль по максимально
высокой цене за минимальные сроки, а покупателю — выгодно приобрести автомобиль
по подходящей цене без необходимости физического осмотра — благодаря высоким
требованиям к диагностике и оценке лотов продавцами.<br>
3.1.2. По окончании аукциона покупатель, сделавший последнюю ставку, обязан
связаться с продавцом в срок не позднее 5 часов и завершить сделку не позже 1
дня после фактического завершения аукциона.<br>
3.2. Ценообразование и ставки<br>
3.2.1. Лот выставляется на торги Продавцом по начальной цене, которая
указывается на усмотрение продавца.<br>
Продавец имеет право указать «Цену покупки без аукциона».<br>
«Цена покупки без аукциона» — это ставка, которая завершает торги досрочно.
Пользователь, сделавший такую ставку, автоматически объявляется Победителем
торгов, т.е. покупает лот по указанной цене.<br>
Если покупатель заинтересован в лоте, но считает начальную цену завышенной, он
может указать цену меньше начальной. В случае отсутствия ставок равных или выше
...
5.2.1. Нести ответственность за действия, совершенные в системе по
регистрационным данным. Любые сделанные ставки означают осознанные действия с
обязательством приобрести лот по цене сделанной ставки.<br>
5.2.2. Соблюдать условия настоящего Соглашения и неукоснительно соблюдать
требования действующего законодательства Российской Федерации.<br>
...
"Cambria",serif;color:#333333'>.</span><span lang=EN-US style='text-align: left;font-size:10.0pt;
font-family:"Cambria",serif;color:#333333'>perekup</span><span lang=RU
                                                               style='text-align: left;font-size:10.0pt;font-family:"Cambria",serif;color:#333333'>64.ru в
...
продажу в Торговой системе car-bid.ru, оставаясь при этом единственным лицом,
...
5.2.6. Продавец гарантирует, что он имеет все необходимые полномочия для
продажи выставленного автомобиля по цене не ниже начальной, автомобиль не
находится в залоге, аресте, не обременен иным образом правами третьих лиц, а
также отсутствие запрета на регистрационные действия на представленный
...
сервиса для выше упомянутого Пользователя.<br>
5.3.2. По своему усмотрению вводить, отменять или изменять плату за
предоставляемые Сервисом услуги.<br>
5.3.5. Приостановить или прекратить регистрацию и доступ Пользователя на Сервис
</span><span lang=EN-US style='text-align: left;font-size:10.0pt;font-family:"Cambria",serif;
color:#333333'>www</span><span lang=RU style='text-align: left;font-size:10.0pt;font-family:
"Cambria",serif;color:#333333'>.</span><span lang=EN-US style='text-align: left;font-size:10.0pt;
font-family:"Cambria",serif;color:#333333'>perekup</span><span lang=RU
...
5.4. Торговая система обязуется:<br>
5.4.1. Предоставлять зарегистрированным Пользователям доступ к предназначенной
...
изменениях.<br>
5.4.4. Не предоставлять информацию, полученную от Пользователей (включая адрес
...
информации, размещаемой Пользователями на сайте car-bid.ru, а также за
...
информации необходимо согласно требованиям действующего российского
законодательства.<br>
...
информацию о своем пароле. В случае если информация о пароле Пользователя по
тем или иным причинам станет известна третьим лицам, Пользователь обязуется
немедленно изменить его.<br>
...
переговоров.<br>
9.2. Если какие-либо споры, разногласия или требования, возникающие из
настоящего Соглашения или в связи с ним, в том числе касающиеся его исполнения,
нарушения, прекращения или недействительности, не разрешены в соответствии с п.
9.1. настоящего Соглашения, то дело рассматривается в соответствии с
действующим законодательством РФ в судебном порядке.<br>
9.3. Сервис </span><span lang=EN-US style='text-align: left;font-size:10.0pt;font-family:"Cambria",serif;
color:#333333'>www</span><span lang=RU style='text-align: left;font-size:10.0pt;font-family:
"Cambria",serif;color:#333333'>.</span><span lang=EN-US style='text-align: left;font-size:10.0pt;
font-family:"Cambria",serif;color:#333333'>perekup</span><span lang=RU
                                                               style='text-align: left;font-size:10.0pt;font-family:"Cambria",serif;color:#333333'>64.</span><span
...
настоящего Соглашения. В таком случае Соглашение считается расторгнутым по
истечении 30 (тридцати) календарных дней с момента получения уведомления по
электронной почте. Стороны Соглашения не освобождаются от обязательств,
возникших до прекращения действия Соглашения по тем или иным основаниям, в
